          ...
          <div className="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
            <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
              <li className="flex-1 md:flex-none md:mr-3">
                <a
                  className="link inline-block py-2 px-4 text-white no-underline"
                  href="#"
                >
                  Área Administrativa
                </a>
              ...
              <li className="flex-1 md:flex-none md:mr-3">
                <div className="relative inline-block">
                  ...
                  >
                    ...
                    >
                      <i className="fa fa-user fa-fw"></i> Perfil
                    </a>
                    <a
                      href="#"
                      className="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"
                    >
                      <i className="fa fa-cog fa-fw"></i> Configurações
                    </a>
                    ...
                    <a
                      ...
                      className="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"
                    >
                      <i className="fas fa-sign-out-alt fa-fw"></i> Sair
                    </a>
                  </div>
                </div>
              </li>
